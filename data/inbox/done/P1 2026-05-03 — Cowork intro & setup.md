...
![What is Cowork: Plan, Execute, Connect](https://everpath-course-content.s3-accelerate.amazonaws.com/instructor%2F6oz04skclb1pbkcboeiosbn5o%2Fpublic%2F1773281046%2Fslide-02-what-is-cowork.1773281046198.png)
> **Image OCR (auto):**
> **Type:** other
> **Text:** What is Cowork
> A desktop workspace
> where you and Claude
> get work done
> 
> Cowork uses the same agentic architecture that
> powers Claude Code, now accessible within Claude
> Desktop. Instead of responding one message at a
> time, Claude can take on complex, multi-step tasks
> and execute them on your behalf.
> 
> Plan
> Claude breaks
> down your task
...
> email, apps via
> MCP
> **Description:** A marketing-style webpage section on a beige background promoting “Cowork.” It features a large headline about a desktop workspace with Claude, a short explanatory paragraph, and three feature cards labeled Plan, Execute, and Connect. On the right is a simple abstract line illustration.
...
![Cowork capabilities: six core capability tiles](https://everpath-course-content.s3-accelerate.amazonaws.com/instructor%2F6oz04skclb1pbkcboeiosbn5o%2Fpublic%2F1773939331%2Fslide-03-capabilities.1773939330948.png)
> **Image OCR (auto):**
> **Type:** ui-screenshot
> **Text:** Capabilities
> What Cowork can do
...
> 
> File operations
> Read, edit, and create PPTX,
> Excel, Word docs, and any
> common file type
> 
> Plugins
> Domain expertise built in —
> skills and workflows for your
> role
> 
> Scheduled tasks
> Automate repetitive
> workflows on a regular
> cadence
> 
> Subagents
> Parallelize complex
...
> containers for advanced
> analytics
> **Description:** A clean marketing-style webpage section titled “What Cowork can do” under the smaller label “Capabilities.” It shows six feature cards in a 3-column grid, each with a simple line icon, a bold heading, and a short description. The cards describe connectors, file operations, plugins, scheduled tasks, subagents, and data analysis.
...
As you progress through the course, we'd love to hear how you're using concepts from it in your work. Share your feedback [here](https://forms.gle/sY9ou5fqZBd3TjHF8).
...
> macOS or Windows (x64). Not available on web or
> mobile.
> 
> 2  Paid Claude subscription
> Available on Pro, Max, Team, and Enterprise plans.
> 
> 3  Active internet connection
> Required throughout your session. Cowork won’t work
> offline.
> 
> 4  Keep Claude Desktop open
> Closing the app ends your session. Leave it running while
> Claude works.
> **Description:** This image is a clean instructional graphic listing requirements and availability for using Claude Desktop. It shows four numbered items in rounded boxes on the left and simple checkbox-style illustrations on the right. The overall design looks like a documentation or onboarding page rather than a UI screenshot or technical diagram.


Overview

Cowork runs in the [Claude Desktop app](https://claude.com/download). It's available on paid Claude plans— [check your plan details](https://claude.com/pricing) for current availability.
...
> approach, then let it run.
> **Description:** A clean instructional graphic titled “Accessing Cowork” under a “Getting started” label. It shows three numbered cards with arrows between them, explaining how to open Claude Desktop, switch to the Cowork mode, and describe a task. The layout is minimal with large typography and short explanatory text in each step.
...
Some of your work lives on pages that don't have a connector—an internal dashboard, a vendor portal, a web app behind your login. [Claude in Chrome](https://claude.com/claude-for-chrome) is how Cowork reaches those. You install it from the same Customize area, grant permissions per site, and Cowork can open pages, read content, and interact with them as part of a task.

On its own, the extension is a sidebar assistant that reads your current tab. The automation happens when Cowork drives it. For a walkthrough, see the [Chrome tutorial](https://claude.com/resources/tutorials/simplify-your-browsing-experience-with-claude-for-chrome), or for the extension working alongside your local files, [Build analysis from browser charts and folder data](https://claude.com/resources/use-cases/build-analysis-from-browser-charts-and-folder-data).
...
For detailed setup help, see the Help Center: [Getting started with Cowork](https://support.claude.com/en/articles/13345190). Team and Enterprise admins should also review [Cowork for Team/Enterprise](https://support.claude.com/en/articles/13455879).
