---
title: P4 2026 05 03 Cowork Files Research
slug: p4-2026-05-03-cowork-files-research
source_url: https://anthropic.skilljar.com/introduction-to-claude-cowork/444171
source_type: article
...
![File and document use cases: starting prompts](https://everpath-course-content.s3-accelerate.amazonaws.com/instructor%2F6oz04skclb1pbkcboeiosbn5o%2Fpublic%2F1773313486%2Fslide-13-file-document-tasks.1773313486756.png)
> **Image OCR (auto):**
> **Type:** diagram
> **Text:** Use cases
> Files, documents & creation
> 
> Organize files
> "Sort my Downloads folder
> by type and date into
> categorized folders"
> 
> Process receipts
> "Create a formatted
> expense report from all
...
> 
> Build presentations
> "Turn these meeting notes
> into a polished slide deck"
> 
> Polished reports
> "Combine voice memos and
> notes into a formatted
> document."
> **Description:** A clean marketing-style graphic titled “Files, documents & creation” under the small label “Use cases.” It shows six rounded cards arranged in a 3-by-2 grid, each describing a file/document task such as organizing files, processing receipts, batch renaming, creating spreadsheets, building presentations, and producing polished reports. The design uses a light background with bold headings and short quoted example prompts inside each card.
...
For more task ideas, browse the [Cowork use-case gallery](https://claude.com/resources/use-cases/).
...
> Work that fits Cowork's shape — volume, parallelism, in-place
> results.
> 
> Research synthesis
> Combine web searches, articles, papers,
> and your notes into coherent reports or
> summaries.
> 
> Transcript analysis
> Extract themes, key points, and action
> items from meeting notes, interviews, or
> recordings.
> 
> Data analysis
> Statistical analysis, outlier detection,
> cross-tabulation, and time-series on your
> data files.
> 
> Data transformation
> Clean, transform, visualize, and process
> datasets. Generate charts from your data.
> 
> Knowledge synthesis
> Analyze your notes, journals, or research files to surface patterns, themes, and connections you might
> have missed.
> **Description:** A clean marketing webpage section titled “Research, analysis & synthesis” under the “Use cases” heading. It shows four feature cards for research synthesis, transcript analysis, data analysis, and data transformation, plus a highlighted “Knowledge synthesis” panel at the bottom. The layout uses simple line icons and short explanatory blurbs on a light background.
