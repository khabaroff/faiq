...
![](https://substackcdn.com/image/fetch/$s_!a8_C!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff2a6bc88-8fd8-4e35-9015-f233c990a247_1080x1350.png)

You know Projects and Cowork. Don’t forget Claude Code.

And here’s the entire Claude product line, in short:

1. **Chat** → it’s like ChatGPT. A chatbot.
2. **Project** → it’s still Claude Chat, but separated as individual Projects.
...
3. Open the app. Click on the **Code** tab at the top next to Chat & Cowork.
4. Select a folder from your computer. More about it down below.
...
![](https://substackcdn.com/image/fetch/$s_!y8_p!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcd9963ab-bbf0-4a9f-98da-01e3cf183068_3456x1990.png)

The sign-up is free.

![](https://substackcdn.com/image/fetch/$s_!qwN4!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1039f96a-16f2-49d2-8161-cd3821cc2ee6_3456x1975.png)
...
2. Click on your **Settings** → **Connectors**.
3. Go to **Browse connectors** → Search **GitHub** → **Connect** your GitHub.

![](https://substackcdn.com/image/fetch/$s_!5Q-4!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe8f18516-5f98-4351-a37a-b0adbb6eeec7_3456x2172.png)

Go to your profile (bottom left) and click on Settings (step 2).

![](https://substackcdn.com/image/fetch/$s_!yO3s!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3836c3c3-15eb-4b31-a447-ffc20f4cc1ab_3456x2168.png)

Go to Connectors → Browse connectors → Search GitHub Connect it.

#### Step 3: Code, but without code. Just type words.

1. Now go to Claude Code.
2. Use **Opus 4.6** + **Auto accept edits**.
3. Make sure your GitHub is connected.
...
![](https://substackcdn.com/image/fetch/$s_!RObN!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F67febe56-6af9-4ba0-9dfe-95de0dd5c309_3456x2172.png)
...
![](https://substackcdn.com/image/fetch/$s_!nqYe!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fab08146b-e959-4f96-92f8-d5e3682f1d9f_3456x2172.png)

An example of recreating a company I know: iovis, an Airbnb for musicians.

![](https://substackcdn.com/image/fetch/$s_!71pK!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6fe4a098-2268-4e83-a228-34b73a62c588_3456x2172.png)

Click on “Always allow for session” every single time.

![](https://substackcdn.com/image/fetch/$s_!PaPG!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24a6244a-1d62-482f-9a92-f7c0a3e29295_3456x2172.png)
...
2. Note down all of the problems you see when navigating.
3. Follow up in Claude Code with a numbered list of the issues.
4. Claude Code fixes it one by one.
5. You go back to the live website. Refresh. Note down the issues…
...
![](https://substackcdn.com/image/fetch/$s_!Zgm5!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd8ffb7a6-b0ad-4b18-abfd-67fb1c2ccdbb_3456x2172.png)
...
![](https://substackcdn.com/image/fetch/$s_!BgiU!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F489560bd-c058-4074-9aad-38e39b82a35e_3456x1926.png)
...
![](https://substackcdn.com/image/fetch/$s_!PZ3P!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbe1c1f9a-125f-47ef-91c7-1702539f9b1a_3456x2170.png)

Step 1: Bottom left “ Settings ” → Click on “ Extensions ”

![](https://substackcdn.com/image/fetch/$s_!br31!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0977c278-5831-475e-a6f0-cd4af2eef3b0_3456x2168.png)
...
![](https://substackcdn.com/image/fetch/$s_!IHr8!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F39c4eaf9-1c2c-429c-a027-f2592b02937e_3456x2170.png)

Step 1: Access the settings. It’s the only time we will.

![](https://substackcdn.com/image/fetch/$s_!APa3!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe83df810-9675-469c-99f6-001ae00005c1_3456x2164.png)
...
![](https://substackcdn.com/image/fetch/$s_!UU8x!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2cf814ea-0148-4bbd-af82-cf0bfc576d93_3456x2168.png)
...
This is vibecoding at full speed:
 ...
 <video controls=""><source src="https://ruben.substack.com/api/v1/video/upload/055469d7-61ba-4591-98a5-f2bdaffe22ca/src?override_publication_id=4937949&amp;type=hls" type="application/x-mpegURL"> <source src="https://ruben.substack.com/api/v1/video/upload/055469d7-61ba-4591-98a5-f2bdaffe22ca/src?override_publication_id=4937949&amp;type=mp4" type="video/mp4"></video>
